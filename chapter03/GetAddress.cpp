...
llvm::Function *createFuncProto(std::string funcName)
{
    ...
    llvm::Type *vectorTy = llvm::VectorType::get(u32Ty, 2, false);
    llvm::Type *ptrTy    = vectorTy->getPointerTo(0);
...
llvm::Value *getGEP(llvm::Value *base, llvm::Value *offset)
{
...
int main()
{
    ...
    llvm::Value *gep = getGEP(base, Builder->getInt32(1));
